    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.content}>
                ...
                <p>Join us in celebrating Republic Day with our coding contest! The contest will consist of 8 problems, with 4 easy problems targeting first year students, 2 medium problems targeting second year students, and 2 hard problems targeting third and fourth year students. Each problem will have partial marking, and the winner will be the participant who scores the most points the earliest.</p>
