...
const Footer = () => {
  return (
    <div className={styles.footer}>
      ...
      <p>© 2021 Newton School Coding Club, <a className={styles.pccoelink} href="http://www.pccoepune.com/" target="_blank" rel="noreferrer">Pimpri Chinchwad College of Engineering.</a> All Right Reserved.</p>
    </div>
  )
}
